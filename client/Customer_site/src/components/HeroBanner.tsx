      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
          ...
          <div className="bg-card rounded-lg p-3 md:p-4 border border-border">
            <p className="text-primary font-bold text-xs md:text-sm">৳2,445.44 OFF</p>
            <p className="text-xs text-muted-foreground">orders ৳19,441.23+</p>
            <p className="text-primary text-xs font-semibold mt-1 md:mt-2">Code:CD1592</p>
          </div>
          <div className="bg-card rounded-lg p-3 md:p-4 border border-border">
            <p className="text-primary font-bold text-xs md:text-sm">৳244.54 OFF</p>
            <p className="text-xs text-muted-foreground">orders ৳1,834.08+</p>
          ...
          <Link to="/super-deals" className="bg-card rounded-lg p-3 md:p-4 border border-border flex items-center gap-2 md:gap-3 hover:border-primary/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-[10px] md:text-xs font-semibold bg-foreground text-card px-2 py-0.5 rounded mt-1 inline-block">৳ 2,505.35</p>
            </div>
          </Link>
          <Link to="/bundle-deals" className="bg-card rounded-lg p-3 md:p-4 border border-border flex items-center gap-2 md:gap-3 hover:border-primary/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-[10px] md:text-xs font-semibold bg-foreground text-card px-2 py-0.5 rounded mt-1 inline-block">৳ 684.48</p>
            </div>
          </Link>
        </div>
      </div>

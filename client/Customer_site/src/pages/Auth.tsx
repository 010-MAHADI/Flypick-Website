            ...
            {mode === "forgot" ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-border hover:border-muted-foreground hover:bg-muted/50 transition-all duration-200 text-sm font-medium">

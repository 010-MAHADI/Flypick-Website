...
REM Customer site environment
if exist "client\Customer_site\.env.local" (
    copy "client\Customer_site\.env.local" "client\Customer_site\.env" >nul
    echo ✅ Customer site environment switched to local
) else (
    echo ❌ client\Customer_site\.env.local not found
)

REM Seller dashboard environment
if exist "client\seller-side\.env.local" (
    copy "client\seller-side\.env.local" "client\seller-side\.env" >nul
